...
?>
<button onclick="window.location.href='https://w3docs.com';">Log in</button>
<html>
	<head>
	...
	<body>
		<!--<div class="left-menu">
			<ul>
				...
				<table class="header" align="left">
					<tr>
						<td><img src="logo.png" width="140px" height="70px"></td>
						<td><select >
								<option class="option-size">Find A Tutor</option>
								<option>Search for Tutors</option>
								<option>Rrequest A Tutor</option>
								<option>Online Tutoring</option>
								
							</select></td>
							<td><select>
								<option class="option-size">About Us</option>
		...
		<p>yti</p>
		<h1 align="center" style="font-family:verdana;">Login Form</h1>
		<h1 align="center" style="font-family:verdana;">Login Form</h1>
		<div  class="content" style="background-image:url('1st_back.jpg');background-repeat: no-repeat;background-size: cover;"> 
				...
				<table align="center">
					...
					<tr>
						<td><img src="user.jpg" width="150px" height="150px"></td>
