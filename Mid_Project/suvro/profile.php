...
<form action="upload.php" align=center method="post" enctype="multipart/form-data" name="mfm"><pre>
	...
	<table border="0px" width="80%" cellpadding="0px" cellspacing="0px" bgcolor="#f1f1f1">
		<tr>
			<td><b> <img src="./pictures/shuvro.jpg" width="200px" height="200px" > </b></font></td>
			<td>
				<table border="1px">
					<tr>
					...
					<tr border="1px">
						<td> <?php echo "Shuvro Devnath"; ?> </td> <td> <?php echo "01XXXXXXXXX"; ?> </td> 
						<td> <?php echo "shuvro@gmail.com"; ?> </td> <td> <?php echo "Dhaka,Bangladesh"; ?> </td>
						<td> <?php echo "2 Years" ?> </td>
						<td> <a href="bookTutor.php"> Book </a>
					</td>
